...
\pagenumbering{arabic} % setzt Seite auf 1 zurück
\pagestyle{scrheadings}

\begin{spacing}{1}
\chapter{Einführung}\label{chapter:introduction}
\end{spacing}
...
\begin{spacing}{1}
\chapter{Technische Grundlagen}\label{chapter:technical}
\end{spacing}
\input{./sections/technical}

\begin{spacing}{1}
\chapter{Systemarchitektur}\label{chapter:architecture}
\end{spacing}
...
\begin{spacing}{1}
\chapter{Minihandbuch}\label{chapter:minihandbuch}
\end{spacing}
\input{./sections/minihandbuch}

\begin{spacing}{1}
\chapter{Projektevaluation}\label{chapter:projektevaluation}
\end{spacing}
\input{./sections/projektevaluation}
